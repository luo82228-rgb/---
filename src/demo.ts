...
// 编号前缀用 SL-（YP- 是真实编号前缀，不能用）；广告类型一律「其他」（真实类型名也不暴露）——2026-06-11 用户验证后修正。
...
export function buildDemoData() {
  ...
  return {
    ...
    ads: [
      ...
      { ad_no: 'SL-001', brand: '示例品牌A', biz_name: '张示例', group: '示例广告对接群①', ad_type: '其他', ad_mode: 'CPT', amount: '50000', pay_status: '已收款', pay_time: d(0), expire_time: d(0), recorder: '示例记录人', remark: '示例备注：本条为虚拟演示数据' },
      { ad_no: 'SL-002', brand: '示例品牌B', biz_name: '李示例', group: '示例广告对接群②', ad_type: '其他', ad_mode: 'CPS', amount: '30000', pay_status: '未收款', pay_time: d(0), expire_time: d(1), recorder: '示例记录人', remark: '' },
      { ad_no: 'SL-003', brand: '示例品牌A', biz_name: '王示例', group: '示例广告对接群③', ad_type: '其他', ad_mode: 'CPC', amount: '20000', pay_status: '已收款', pay_time: d(0), expire_time: d(-5), recorder: '示例记录人', remark: '沟通中，预计近期补量' },
    ],
    reviews: [
      // ad_no 对应上面 SL-001：品牌汇总「覆盖群」的编号反查可演示
      { date: d(0), brand: '示例品牌A', target: '张示例', reviewer: '示例审查员', ad_no: 'SL-001', scene: '群组', method: '抽查', has_issue: '有', issue_type: '示例问题类型', issue_desc: '示例问题描述：仅用于界面演示', risk_level: '中', is_fixed: '是', fix_time: d(0), is_rechecked: '是', is_closed: '是', ad_amount: '50000', summary: '示例汇总分析：本条为虚拟演示数据，无真实业务含义' },
    ],
    keywords: [
